...
NOTE: If you visited my portfolio and are attempting to run this code, RData and CSV files that are necessary are stored in my GitHub. You can find a link to that from my portolio website by clicking the GitHub icon.
